...
The keys live in `.codex/settings.json` (project) or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/GROUP project/Group-project-AI-ML/.codex/settings.json` (global) — **not** in `.planning/config.json`:

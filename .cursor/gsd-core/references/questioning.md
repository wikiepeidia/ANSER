...
Use conversational prompting to help users think by presenting concrete options to react to.
...
**When the user wants to explain freely, STOP using conversational prompting.**
...
1. **Ask your follow-up as plain text** — NOT via conversational prompting
2. **Wait for them to type at the normal prompt**
3. **Resume conversational prompting** only after processing their freeform response
...
**Wrong:** User says "let me describe it" → conversational prompting("What feature?", ["Feature A", "Feature B", "Describe in detail"])

...
> for project name, milestone, current phase, and next-step routing. .cursor/rules/ ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> .cursor/rules/ project description as a source for any progress report field.

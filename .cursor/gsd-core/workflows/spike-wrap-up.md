...
`./.cursor/skills/spike-findings-[project]/` (project-local) and summary to
...
3. Check if `./.cursor/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.cursor/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.cursor/skills/spike-findings-[project]/`
...
Add an auto-load routing line to the project's .cursor/rules/ (create the file if it doesn't exist):
...
- [ ] Spike-findings skill exists at `./.cursor/skills/` with SKILL.md (including requirements), references/, sources/
...
- [ ] Project .cursor/rules/ has auto-load routing line
- [ ] Summary presented

...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.cursor/skills/sketch-findings-[project]/`
...
3. Check if `./.cursor/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.cursor/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.cursor/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.cursor/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.cursor/skills/` with SKILL.md, references/, sources/

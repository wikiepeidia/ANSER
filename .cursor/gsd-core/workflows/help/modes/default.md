...
Plan-driven development for solo agentic work with Cursor. GSD Core turns a vague idea into a hierarchical plan, then executes it phase by phase with state tracking and atomic commits.

...
The keys live in `.claude/settings.json` (project) or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/GROUP project/Group-project-AI-ML/.cursor/settings.json` (global) — **not** in `.planning/config.json`:

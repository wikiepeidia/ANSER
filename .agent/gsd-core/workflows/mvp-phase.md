...
<required_reading>
@.agent/gsd-core/references/user-story-template.md
@.agent/gsd-core/references/spidr-splitting.md
@.agent/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.agent/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.agent/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@.agent/gsd-core/references/spidr-splitting.md`. Briefly:

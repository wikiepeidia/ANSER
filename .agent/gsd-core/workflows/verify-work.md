...
<template>
@.agent/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.agent/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.agent/gsd-core/workflows/transition.md`.
...
- Follow @.agent/gsd-core/workflows/diagnose-issues.md

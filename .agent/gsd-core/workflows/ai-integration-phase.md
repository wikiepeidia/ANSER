...
<required_reading>
@.agent/gsd-core/references/ai-frameworks.md
@.agent/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read .agent/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp ".agent/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .agent/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .agent/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .agent/agents/gsd-eval-planner.md for instructions.

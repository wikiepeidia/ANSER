...
SPIKE_SKILL=$(ls ./.agent/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.agent/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
Use template: .agent/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: .agent/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: .agent/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: .agent/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: .agent/gsd-core/templates/research-project/SUMMARY.md

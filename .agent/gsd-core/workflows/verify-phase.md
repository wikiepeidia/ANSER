...
<required_reading>
@.agent/gsd-core/references/verification-patterns.md
@.agent/gsd-core/templates/verification-report.md
</required_reading>
...
See .agent/gsd-core/templates/verification-report.md for complete template.
</step>

...
See .agent/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .agent/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using .agent/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agent/gsd-core/templates/discovery.md
...
Use .agent/gsd-core/templates/discovery.md.

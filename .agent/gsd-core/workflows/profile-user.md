...
Key references:
- @.agent/gsd-core/references/ui-brand.md (display patterns)
- @.agent/agents/gsd-user-profiler.md (profiler agent definition)
- @.agent/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".agent/gsd-core/USER-PROFILE.md"
...
```bash
cp ".agent/gsd-core/USER-PROFILE.md" ".agent/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .agent/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `.agent/gsd-core/references/user-profiling.md`
...
Reference: @.agent/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to .agent/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .agent/gsd-core/USER-PROFILE.md" and jump to step 10.
...
```bash
BACKUP_PATH=".agent/USER-PROFILE.backup.md"
```
...
Your profile:    .agent/gsd-core/USER-PROFILE.md
```

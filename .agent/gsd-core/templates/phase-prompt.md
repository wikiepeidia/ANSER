...
<!-- For checkpoint task examples and patterns, see @.agent/gsd-core/references/checkpoints.md -->
...
See `.agent/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.agent/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.agent/gsd-core/workflows/verify-phase.md` for verification logic.

...
`./.gemini/skills/spike-findings-[project]/` (project-local) and summary to
...
- [ ] Spike-findings skill exists at `./.gemini/skills/` with SKILL.md (including requirements), references/, sources/

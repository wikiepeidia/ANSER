...
Use conversational prompting for each. **TEXT_MODE fallback:** when `workflow.text_mode` is true, replace conversational prompting calls with plain-text numbered prompts and wait for typed replies.

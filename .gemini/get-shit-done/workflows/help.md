...
- Saves timestamped note to `.planning/notes/` (or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/GROUP project/Group-project-AI-ML/.gemini/notes/` globally)

...
class AutomationEngine:
    ...
    def execute_import_automation(self, auto_id, config, product_id):
        ...
        try:
            ...
            prod = c.fetchone()
            unit_price = prod['import_price'] if prod and prod['import_price'] else 0
            ...
            c.execute('''INSERT INTO import_transactions
                            ...
                            VALUES (?, ?, ?, ?, ?, ?)''',
                        (code, supplier_id, total_price, 'pending', f'Auto-generated by automation #{auto_id}', 1))
    ...
    def execute_scheduled_import(self, auto_id, config):
        ...
        try:
            ...
            for prod in low_stock_products:
                p_id = prod['id']
                price = prod['import_price'] if prod['import_price'] else 0

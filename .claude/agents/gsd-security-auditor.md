...
**Verification depth scales with `asvs_level`** (see @C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/GROUP project/Group-project-AI-ML/.claude/gsd-core/references/security-asvs-levels.md for full definitions):

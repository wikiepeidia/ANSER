...
> for project name, milestone, current phase, and next-step routing. .clinerules ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> .clinerules project description as a source for any progress report field.

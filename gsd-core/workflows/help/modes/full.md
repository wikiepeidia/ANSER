...
**GSD Core** (Git. Ship. Done.) creates hierarchical project plans optimized for solo agentic development with Cline.
...
- Saves timestamped note to `.planning/notes/` (or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/GROUP project/Group-project-AI-ML/notes/` globally)
...
- **`/gsd:ultraplan-phase [phase]`** — [BETA] Offload plan phase to Cline's ultraplan cloud; review in browser and import back.
